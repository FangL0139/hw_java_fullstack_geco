    ...
    <div>
      ...
      <form className="PostForm">
        <div>
          ...
          <div>
          <input onBlur={(e)=>setName(e.target.value)} type="text" placeholder="Enter name"></input>
        </div>
        <div>
          <label>Job</label>
          </div>
          <div>
            <input onBlur={(e)=>setJob(e.target.value)} type="text" placeholder="Enter Job"></input>
          </div>
